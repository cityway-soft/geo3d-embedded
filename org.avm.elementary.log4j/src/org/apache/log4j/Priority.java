...
/**
 * Defines the minimum set of priorities recognized by the system, that is
 * {@link #FATAL}, {@link #ERROR}, {@link #WARN}, {@link #INFO} and
 * {@link #DEBUG}.
 * 
 * <p>
 * The <code>Priority</code> class may be subclassed to define a larger
 * priority set.
 * 
...
public class Priority {
	...
	/**
	 * The <code>FATAL</code> priority designates very severe error events
	 * that will presumably lead the application to abort.
	 */
	final static public Priority FATAL = new Priority(FATAL_INT, "FATAL", 0);

	/**
	 * The <code>ERROR</code> priority designates error events that might
	 * still allow the application to continue running.
	 */
	final static public Priority ERROR = new Priority(ERROR_INT, "ERROR", 3);

	/**
	 * The <code>WARN</code> priority designates potentially harmful
	 * situations.
	 */
	final static public Priority WARN = new Priority(WARN_INT, "WARN", 4);

	/**
	 * The <code>INFO</code> priority designates informational messages that
	 * highlight the progress of the application at coarse-grained level.
	 */
	final static public Priority INFO = new Priority(INFO_INT, "INFO", 6);

	/**
	 * The <code>DEBUG</code> priority designates fine-grained informational
	...
	/**
	 * Convert the string passed as argument to a priority. If the conversion
