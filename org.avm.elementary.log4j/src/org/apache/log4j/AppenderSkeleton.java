...
public abstract class AppenderSkeleton implements Appender, OptionHandler {
	...
	/**
	 * A string constant used in naming the option for setting the threshold for
	 * the appender. See also {@link #setThreshold setThreshold} method. Current
	 * value of this string constant is <b>Threshold</b>.
	 * 
	 * <p>
	...
	/**
	 * Finalize this appender by calling the imlenentation's <code>close</code>
	 * method.
	 * 
	 * @since 0.8.4
	 */
	 ...
	 * 
	 * <p>
	 * Configurable Appenders must override this method to return the additional
	 * options they accept.
	 */
	...
	/**
	 * Returns this appenders threshold priority. See the {@link #setThreshold}
	...
	/**
	 * Check whether the message priority is below the appender's threshold. If
	 ...
	 * (fixed) layouts or do not use one.
	 */
	 ...
	 * additional options.
	 * 
	 * All classes derived from {@link AppenderSkeleton} admit the <b>Threshold</b>
	 * option, that is the value of the string constant
	...
	/**
	 * Set the threshold priority. All log events with lower priority than the
	 * threshold priority are ignored by the appender.
	 * 
	 * <p>
	 * In configuration files this option is specified by setting the value of
	 * the <b>Threshold</b> option to a priority string, such as "DEBUG",
	 * "INFO" and so on.
	 * 
	 * @since 0.8.3
	 */
