 ...
 * optional <em>format modifiers</em> and a <em>conversion
 character</em>.
 * The conversion character specifies the type of data, e.g. logger, priority,
 ...
 * 
 * <p>
 * For example, for the Logger name "a.b.c" the pattern <b>%c{2}</b> will
 * output "b.c".
 * 
 * </td>
 * </tr>
 ...
 * <td>Used to output the date and time in the format "yyyy.MM.dd hh:mm:ss LTZ"
 * where LTZ is the local time zone (PST, EST, etc).</td>
 * </tr>
 * 
 * <tr>
 * <td align=center><b>D</b></td>
 * <td>Used to output the date and time in the format "yyyy.MM.dd hh:mm:ss GMT"
 * where GMT is the Greenwhich time zone.</td>
 * </tr>
 * 
 * 
 * <tr>
 ...
 * 
 * <td>Left pad with spaces if the Logger name is less than 20 characters long.
 * 
 * <tr>
 * <td align=center>%-20c</td>
...
public class PatternLayout extends Layout {
	...
	/**
	 * A string constant used in naming the option for setting the layout
	 * pattern. Current value of this string constant is <b>ConversionPattern</b>.
	 * 
	 * <p>
	...
	public PatternLayout(String pattern) {
		...
		head = new PatternParser((pattern == null) ? DEFAULT_CONVERSION_PATTERN
				: pattern).parse();
	}
	...
	public void setConversionPattern(String conversionPattern) {
		...
		head = new PatternParser(conversionPattern).parse();
	}
	 ...
	 * 
	 * <p>
	 * <dd>The value determines the conversion pattern used.
	 * 
	 * </dl>
	 */
