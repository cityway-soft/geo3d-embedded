...
/**
 * FlIOException is the base class for all the exceptions generated by any
 * implementation of the IBitstream interface
 */
public class FlIOException extends IOException {
	...
	/**
	 * The (little_)getxxx() or (little_)nextxxx() method failed (exception
	 * condition)
	 */
	...
	private static String errormsg[] = { "End of Data", "Invalid Alignment",
			"Read I/O Failed", "Write I/O Failed", "File Open Failed",
			"System I/O Error", "Invalid Input Type", "Invalid bit size",
			"Not enough data", "Unknown Error" };
	...
	public FlIOException(int error_code) {
		super(
				errormsg[error_code >= NUMBER_OF_EXCEPTION_TYPE ? NUMBER_OF_EXCEPTION_TYPE - 1
						: error_code]);
		reason = error_code >= NUMBER_OF_EXCEPTION_TYPE ? NUMBER_OF_EXCEPTION_TYPE - 1
				: error_code;
	}
