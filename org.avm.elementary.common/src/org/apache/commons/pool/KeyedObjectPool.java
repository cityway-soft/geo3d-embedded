 ...
 * <p>
 * Example of use: <table border="1" cellspacing="0" cellpadding="3"
 ...
 * one instance per key value, or may choose to maintain a pool of instances for
 * each key (essentially creating a {@link java.util.Map Map} of
...
public interface KeyedObjectPool {
	/**
	 * Obtain an instance from my pool for the specified <i>key</i>. By
	 * contract, clients MUST return the borrowed object using
	 ...
	 * using a <i>key</i> that is equivalent to the one used to borrow the
	...
	/**
	 * Return an instance to my pool. By contract, <i>obj</i> MUST have been
	 * obtained using
	 * {@link #borrowObject(java.lang.Object) <tt>borrowObject</tt>} or a
	 * related method as defined in an implementation or sub-interface using a
	 * <i>key</i> that is equivalent to the one used to borrow the
	 * <tt>Object</tt> in the first place.
	 * 
	 * @param key
	 *            the key used to obtain the object
	 * @param obj
	 *            a {@link #borrowObject(java.lang.Object) borrowed} instance to
	 *            be returned.
	 */
	void returnObject(Object key, Object obj) throws Exception;

	/**
	 * Invalidates an object from the pool By contract, <i>obj</i> MUST have
	 * been obtained using {@link #borrowObject borrowObject} or a related
	 * method as defined in an implementation or sub-interface using a <i>key</i>
	 * that is equivalent to the one used to borrow the <tt>Object</tt> in the
	 * first place.
	 * <p>
	 * This method should be used when an object that has been borrowed is
	 * determined (due to an exception or other problem) to be invalid. If the
	 * connection should be validated before or after borrowing, then the
	 * {@link PoolableObjectFactory#validateObject} method should be used
	 * instead.
	 * 
	 * @param obj
	...
	/**
	 * Returns the number of instances corresponding to the given <i>key</i>
	 * currently idle in my pool (optional operation). Throws
	 * {@link UnsupportedOperationException} if this information is not
	 * available.
	 * 
	 * @param key
	 *            the key
	 ...
	 * returned to my pool corresponding to the given <i>key</i> (optional
	 * operation). Throws {@link UnsupportedOperationException} if this
	...
	/**
	 * Returns the total number of instances currently idle in my pool (optional
	 * operation). Throws {@link UnsupportedOperationException} if this
	 * information is not available.
	 * 
	...
	/**
	 * Returns the total number of instances current borrowed from my pool but
	 * not yet returned (optional operation). Throws
	 * {@link UnsupportedOperationException} if this information is not
	 * available.
	 * 
	 ...
	 * Throws {@link UnsupportedOperationException} if the pool cannot be
	 * cleared.
	 * 
	 * @throws UnsupportedOperationException
	 *             when this implementation doesn't support the operation
	 ...
	 * the given <i>key</i> (optional operation). Throws
	...
	/**
	 * Sets the {@link KeyedPoolableObjectFactory factory} I use to create new
	 * instances (optional operation).
	 * 
	 * @param factory
	 *            the {@link KeyedPoolableObjectFactory} I use to create new
	 *            instances.
