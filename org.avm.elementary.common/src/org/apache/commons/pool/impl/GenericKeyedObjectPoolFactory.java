...
public class GenericKeyedObjectPoolFactory implements KeyedObjectPoolFactory {
	...
	public GenericKeyedObjectPoolFactory(KeyedPoolableObjectFactory factory,
		...
		this(factory, config.maxActive, config.whenExhaustedAction,
				config.maxWait, config.maxIdle, config.testOnBorrow,
				config.testOnReturn, config.timeBetweenEvictionRunsMillis,
	...
	public KeyedObjectPool createPool() {
		return new GenericKeyedObjectPool(_factory, _maxActive,
				_whenExhaustedAction, _maxWait, _maxIdle, _maxTotal, _minIdle,
