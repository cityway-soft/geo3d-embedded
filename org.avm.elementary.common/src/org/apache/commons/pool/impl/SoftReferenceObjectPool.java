 ...
 * @version $Revision: 1.5 $ $Date: 2011/05/10 13:22:09 $
 */
public class SoftReferenceObjectPool extends BaseObjectPool implements
		ObjectPool {
	...
	public synchronized Object borrowObject() throws Exception {
		...
		while (null == obj) {
			if (_pool.isEmpty()) {
				...
				SoftReference ref = (SoftReference) (_pool
						.remove(_pool.size() - 1));
				obj = ref.get();
			}
