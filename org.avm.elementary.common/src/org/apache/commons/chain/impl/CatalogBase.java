...
/**
 * <p>
 * Simple in-memory implementation of {@link Catalog}. This class can also be
 * used as the basis for more advanced implementations.
 * </p>
 * 
 * <p>
...
public class CatalogBase implements Catalog {
	 ...
	 * <code>Map</code>. All Map keys should be <code>String</code> and all
	 * values should be <code>Command</code>.
	 * </p>
	 * 
	 * @param commands
	 *            Map of Commands.
	...
	/**
	 * <p>
	 * Add a new name and associated {@link Command} to the set of named
	 * commands known to this {@link Catalog}, replacing any previous command
	 * for that name.
	 * 
	 * @param name
	 *            Name of the new command
	 * @param command
	 *            {@link Command} to be returned for later lookups on this name
	 */
	...
	/**
	 * <p>
	 * Return the {@link Command} associated with the specified name, if any;
	 * otherwise, return <code>null</code>.
	 * </p>
	 * 
	 * @param name
	 *            Name for which a {@link Command} should be retrieved
