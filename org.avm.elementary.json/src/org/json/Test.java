...
public class Test {
	...
	public static void main(String args[]) {
		...
		try {
			...
			jj = new JSONStringer();
			s = jj.object().key("foo").value("bar").key("baz").array().object()
					.key("quux").value("Thanks, Josh!").endObject().endArray()
					.endObject().toString();
			...
			j
					.put("comment",
							"This object contains a test object that implements JSONString");
