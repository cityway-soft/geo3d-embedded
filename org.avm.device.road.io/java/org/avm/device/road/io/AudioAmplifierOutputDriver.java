...
public class AudioAmplifierOutputDriver implements Driver, Constants {
	...
	public static final String MODEL = "org.avm.device.road.io.AudioAmplifierOutput";

	public static final String SERIAL = "fad1bee0-07dc-4841-87e2-d76b9909a84b";
	...
	private AudioAmplifierOutputServiceTracker _tracker;

	public AudioAmplifierOutputDriver() {
	}
	...
	protected void activate(ComponentContext context) {
		...
		_context = context;
		_tracker = new AudioAmplifierOutputServiceTracker(context
				.getBundleContext());
		_tracker.open();
	}
	...
	class AudioAmplifierOutputServiceTracker extends ServiceTracker {

		public AudioAmplifierOutputServiceTracker(BundleContext context) {
