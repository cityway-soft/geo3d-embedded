...
/**
 * @author lbr **Voir bdd/content/win/INFO.xml <?xml version="1.0"
 *         encoding="UTF-8"?> <container name="INFO" menu="MAIN"> <clock x="204"
 *         y="0" w="36" h="10" font="FNT_7B" name="time" bg="BLACK" fg="WHITE"/>
 * 
 ...
 * font="FNT_7S" bg="BLACK" fg="WHITE" name="14"/> </container>
 */
public class MmiDialogInWrapper4Info extends MmiDialogInWrapper {
	// Singleton
	private static MmiDialogInWrapper4Info INSTANCE = null;

	private MmiDialogInWrapper4Info() {
		super();
	}

	public synchronized static MmiDialogInWrapper4Info getNewInstance(
			String etat) {
		if (INSTANCE == null)
			INSTANCE = new MmiDialogInWrapper4Info();
		INSTANCE.reset();
		INSTANCE.setDialogName(MmiConstantes.INFO);
