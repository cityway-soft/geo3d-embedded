...
public class HmiTest extends TestCase {

	public static void main(String[] args) {
		junit.textui.TestRunner.run(HmiTest.class);
	}
	...
	private byte[] test(byte[] buffer) throws Exception {
		...
		State bMessage = MessageFactory.get(bin);
		System.out.println("\n bin -> obj " + bMessage);
		...
		State xMessage = MessageFactory.unmarshal(xml);
		System.out.println("\n xml -> obj " + xMessage);
