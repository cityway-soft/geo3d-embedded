...
//
// RCS ID
// $Id: TransitionUndefinedException.java,v 1.2 2010/08/23 10:50:13 geolia Exp $
//
// Change Log
...
/**
 * A <code>TransitionUndefinedException</code> is thrown by an SMC-generated
 * state machine whenever a transition is taken which:
 * <ol>
 * <li>Is not explicitly defined in the current state.
 * <li>Is not explicitly defined in the current FSM's default state.
...
public final class TransitionUndefinedException extends RuntimeException {
	/**
	 * Constructs a <code>TransitionUndefinedException</code> with no detail
	 * message.
	 */
	...
	/**
	 * Constructs a <code>TransitionUndefinedException</code> with a detail
	 * message.
	 * 
	 * @param reason
	 *            the detail message.
