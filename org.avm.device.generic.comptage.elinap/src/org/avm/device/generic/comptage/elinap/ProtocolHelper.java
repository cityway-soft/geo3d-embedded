...
public class ProtocolHelper {
	 ...
	 * 	STX : 0x02
	 *  Adress :  A - Z, toujours à A
	 *  Command : commande VIS utilisée
	 *  Data Length : longeur des données sur 4 char en hexa, =15 soit 000F dans notre cas
	 *  Data : la destination
	 *  ETX : 0x03
	 */
	...
	public static byte[] generate(final String destination) {
		...
		//-- ajout [STX]
		buf.append((char) STX);
		// terminal A, commande VIS, taille fixe à 15 = F, message external = E, XXXX caractères non utilisés
