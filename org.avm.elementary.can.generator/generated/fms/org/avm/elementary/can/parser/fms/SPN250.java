...
public class SPN250 extends SPN {

    public static final String name = "SPN250";
	public static final String description = "Engine Total Fuel Used";
	public static final String type = "Fuel_Used_Liquid";
	public static final String unit = "l/h";
	public static final double min = 0.0;
	public static final double max = 2105540607.5;
    ...
    public void get(Bitstream bs) throws IOException {              
    	long v = bs.little_getbits(80, 32);
