...
public class SPN962 extends SPN {

    public static final String name = "SPN962";
	public static final String description = "Day";
	public static final String type = "Time";
	public static final String unit = "Days";
	public static final double min = 0.0;
	public static final double max = 62.5;
