...
public class SPN964 extends SPN {

    public static final String name = "SPN964";
	public static final String description = "Year";
	public static final String type = "Time";
	public static final String unit = "Months";
	public static final double min = 1985.0;
	public static final double max = 2235.0;
	public static final double scale = 1.0;
	public static final double offset = 1985.0;
