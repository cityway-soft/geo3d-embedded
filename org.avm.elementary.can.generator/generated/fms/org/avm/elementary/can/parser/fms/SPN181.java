...
public class SPN181 extends SPN {

    public static final String name = "SPN181";
	public static final String description = "Cargo Weight";
    ...
    public void get(Bitstream bs) throws IOException {              
    	long v = bs.little_getbits(88, 16);
