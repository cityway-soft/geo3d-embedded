...
public abstract class GirouetteProtocol {
	...
	public abstract byte[] generateDestination(String code);
	...
	public final void sendDestination(String code) throws IOException {
		byte[] buffer = generateDestination(code);
		send(buffer);
	}
