/* vim:set softtabstop=3 shiftwidth=3 tabstop=3 expandtab tw=72:
   $Id: MD4.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
 ...
 * 
 * <p>
 * This implementation is derived from the version of MD4 in <a
 * href="http://www.gnu.org/software/gnu-crypto/">GNU Crypto.
 * </p>
 * 
 * <p>
 * References:
...
public class MD4 extends MessageDigestSpi implements Cloneable {
	...
	protected int engineDigest(byte[] out, int off, int len)
		...
		System.arraycopy(engineDigest(), 0, out, off, Math.min(len,
				DIGEST_LENGTH));
