/* ChecksumEncoder -- encodes checksums to external representations.
   $Id: ChecksumEncoder.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
public abstract class ChecksumEncoder {
	 ...
	 *             If the specified encoding cannot be found, or if any of the
	...
	public static ChecksumEncoder getInstance(String encoding,
		...
		try {
			...
			return (ChecksumEncoder) c
					.newInstance(new Object[] { config, out });
