/* ListenerException.java -- Exception thrown by listeners.
   $Id: ListenerException.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
/**
 * Signals an exception raised by an
 * 
 * @{link GeneratorListener},
 * @{link MatcherListener}, or
 * @{link RebuilderListener}.
 * 
 * <p>
 * Listener exceptions may contain other exceptions (the "cause") and may be
 * chained together if there are multiple failures accross multiple listeners.
 */
public class ListenerException extends Exception {
	...
	/**
	 * Returns the next exception in this chain, or <code>null</code> if there
	...
	/**
	 * Gets the cause of this exception, or <code>null</code> if the cause is
	 * unknown.
	 * 
	 * @return The cause.
	 */
