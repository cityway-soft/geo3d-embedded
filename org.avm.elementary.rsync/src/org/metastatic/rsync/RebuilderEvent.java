/* RebuilderEvent -- file rebuilding event.
   $Id: RebuilderEvent.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
/**
 * a rebuilder event. Rebuilder events are emitted by a {@link RebuilderStream}
 * each time a new {@link Delta} is applied. The stream will send this event to
 * each of its {@link RebuilderListener}s.
 * 
 * @see RebuilderStream
...
public class RebuilderEvent extends java.util.EventObject {
	 ...
	 * 
	 * @param data
	 *            The source of this event, the data block.
	 * @param offset
	 *            The destination offset.
	 */
	 ...
	 * java.util.EventObject#getSource()} but the source is already cast for
	 * convenience.
	 * 
