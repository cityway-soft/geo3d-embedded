/* vim:set softtabstop=3 shiftwidth=3 tabstop=3 expandtab tw=72:
   $Id: BrokenMD4.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
/**
 * <p>
 * An implementation of Ron Rivest's MD4 message digest algorithm. MD4 was the
 * precursor to the stronger MD5 algorithm, and while not considered
 * cryptograpically secure itself, MD4 is in use in various applications. It is
 * slightly faster than MD5.
 * </p>
 * 
 * <p>
 * This implementation is provided for compatibility with the "MD4"
 * implementation in the C version of rsync -- which differs in that the input
 * is NOT padded when the input is divisible by 64, and that only the lower 32
 * bits of the length is used in the padding (the real MD4 always pads the input
 * and uses the entire 8 bytes in the padding).
 * 
 * <p>
 * <strong>DO NOT USE THIS IMPLEMENTATION IN NEW PROGRAMS.</strong>
 * </p>
 * 
 * <p>
 * References:
...
public final class BrokenMD4 extends MD4 implements Cloneable {
	...
	/**
	 * Pad the buffer by appending the byte 0x80, then as many zero bytes to
	 * fill the buffer 8 bytes shy of being a multiple of 64 bytes, then append
	 * the length of the buffer, in bits, before padding.
	 */
