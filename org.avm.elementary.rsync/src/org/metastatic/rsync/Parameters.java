/* vim:set softtabstop=3 shiftwidth=3 tabstop=3 expandtab tw=72:
   $Id: Parameters.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
/**
 * <p>
 * Simple parser for Samba-style config files. The parameters are passed back to
 * the caller via a simple event listener callback interface,
 * {@link ParameterListener}.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Blank lines, and lines that begin with either '#' or ';' are ignored. long
 * lines may be continued by preceding the end-of-line character(s) with a
 * backslash ('\').
 * </p>
 * 
...
public final class Parameters {
	 ...
	 * imlpmentation of {@link ParameterListener} which will take the parsed
	 * arguments.
	 * 
	 * @param listener
	...
	/**
	 * Parse, or continue parsing the file if a parsing error occured in a
	 * previous call to this method. A call to {@link #begin(java.lang.String)}
	 * must have succeeded before this method is called.
	 * 
	 * @throws ParameterException
	 *             If a parsing error occurs. Parsing can continue if this
	 *             exception is thrown by calling this method again.
	 * @throws IOException
	 *             If an I/O error occurs.
	 */
	public void parse() throws IOException {
		...
		while ((line = in.readLine()) != null) {
			...
			if (line.startsWith("[") && line.endsWith("]")) {
				listener.beginSection(crush(line
