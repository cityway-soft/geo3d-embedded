/* Sender -- File-sending methods.
   $Id: Sender.java,v 1.2 2008/06/18 13:04:56 cvs Exp $
...
public class Sender implements Constants, MatcherListener {
	...
	private static Logger logger = Logger.getInstance(Sender.class.getName());
	 ...
	 * @param amServer
	 *            Should be true if we are the server.
	 */
