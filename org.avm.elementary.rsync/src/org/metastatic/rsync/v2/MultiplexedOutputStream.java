/* MultiplexedOutputStream -- Multiplexed output.
   $Id: MultiplexedOutputStream.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
 ...
 */
public class MultiplexedOutputStream extends OutputStream implements
		MultiplexedIO {
	...
	/**
	 * Write a message to the multiplexed error stream. If this object was not
	 * configured with to multiplex messages, then this method does nothing.
	 * 
	 * @param logcode
	 *            The log code.
	 * @param message
	 ...
	 *            The bytes to write.
	 * @param off
	 *            The offset from whence to begin.
	 * @param len
	...
	/**
	 * Write a long integer to the stream, in little-endian order, writing four
	 * bytes if the value fits into four bytes, otherwise writing eight bytes.
	 * 
	 * @param l
