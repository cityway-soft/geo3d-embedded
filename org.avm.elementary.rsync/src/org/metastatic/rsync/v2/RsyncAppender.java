/* vim:set softtabstop=3 shiftwidth=3 tabstop=3 expandtab tw=72:
   $Id: RsyncAppender.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
/**
 * Concrete Appender implementation that sends logging information over the wire
 * on the multiplexed data stream. This is only used if we are the "server" in
 * the transaction.
 * 
...
final class RsyncAppender extends AppenderSkeleton {
	...
	protected void append(LoggingEvent e) {
		try {
			if (e.priority.isGreaterOrEqual(Priority.WARN)) {
