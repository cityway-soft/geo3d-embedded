/* MultiplexedInputStream -- Multiplexed input.
   $Id: MultiplexedInputStream.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
 ...
 */
public class MultiplexedInputStream extends InputStream implements
		MultiplexedIO {
	...
	private static Logger logger = Logger
			.getInstance(MultiplexedInputStream.class.getName());
	...
	/**
	 * Attempt to fully read <tt>len</tt> bytes, blocking until all data is
	 * read.
	 * 
	 * @param buf
	 *            The buffer to read into.
	 * @param off
	 *            From whence to start storage in <tt>buf</tt>.
	 * @param len
	...
	/**
	 * Attempt to read as many bytes as will fit into the buffer, blocking until
	 * it has been filled.
	 * 
	 * @param buf
	 *            The buffer to read into.
	...
	/**
	 * Read <tt>len</tt> bytes, returning them as a {@link java.lang.String}
	...
	/**
	 * Do an unbuffered read from the multiplexed input stream, putting normal
	 * data into the byte buffer and sending error stream data to {@link #err}.
	 * 
	 * @param buf
	 *            The byte buffer to read into.
	 * @param off
	 *            From whence in the buffer to begin.
	 * @param len
