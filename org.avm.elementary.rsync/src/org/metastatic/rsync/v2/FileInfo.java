/* FileInfo -- information about files being tranferred.
   $Id: FileInfo.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
/**
 * Basic information about files that are being sent over the wire. Roughly
 * analogous to 'struct file_struct' in rsync.h.
 * 
...
public class FileInfo implements Constants {
	...
	public String toString() {
		...
		if (len.length() <= 10)
			buf.append("          ".substring(0, 10 - len.length()))
					.append(len);
		else
			buf.append(len);
		buf.append(' ');
