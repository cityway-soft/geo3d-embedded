/* LoggerPrintStream -- append print statements to loggers.
   $Id: LoggerPrintStream.java,v 1.2 2008/06/18 13:04:55 cvs Exp $
...
public class LoggerPrintStream extends PrintStream {
	...
	public LoggerPrintStream(Logger logger, Priority logPriority) {
	...
	public void println() {
		if (open) {
			// [DSU] logger.log(logPriority, line.toString());
