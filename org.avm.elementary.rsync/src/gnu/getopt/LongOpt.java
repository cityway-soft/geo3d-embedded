...
public class LongOpt extends Object {
	...
	/**
	 * Constant value used for the "has_arg" constructor argument. This value
	...
	/**
	 * Constant value used for the "has_arg" constructor argument. This value
	 * indicates that the option takes an argument that is required.
	 */
	public static final int REQUIRED_ARGUMENT = 1;

	/**
	 * Constant value used for the "has_arg" constructor argument. This value
	 * indicates that the option takes an argument that is optional.
	 */
	...
	/**
	 * Create a new LongOpt object with the given parameter values. If the value
	 * passed as has_arg is not valid, then an exception is thrown.
	 * 
	 * @param name
	 *            The long option String.
	 * @param has_arg
	 *            Indicates whether the option has no argument (NO_ARGUMENT), a
	 *            required argument (REQUIRED_ARGUMENT) or an optional argument
	 *            (OPTIONAL_ARGUMENT).
	 * @param flag
	 *            If non-null, this is a location to store the value of "val"
	 *            when this option is encountered, otherwise "val" is treated as
	 *            the equivalent short option character.
	 * @param val
	 *            The value to return for this long option, or the equivalent
	 *            single letter option to emulate if flag is null.
	 * 
	 * @exception IllegalArgumentException
	 *                If the has_arg param is not one of NO_ARGUMENT,
	...
	public LongOpt(String name, int has_arg, StringBuffer flag, int val)
		...
		if ((has_arg != NO_ARGUMENT) && (has_arg != REQUIRED_ARGUMENT)
			...
			throw new IllegalArgumentException(MessageFormat.format(_messages
