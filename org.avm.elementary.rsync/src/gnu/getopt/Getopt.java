...
public class Getopt extends Object {
	...
	public Getopt(String progname, String[] argv, String optstring,
		...
		if (System.getProperty("gnu.posixly_correct", null) == null)
			...
			_messages = PropertyResourceBundle.getBundle(
					"gnu/getopt/MessagesBundle", Locale.US);
		}
	...
	protected int checkLongOption() {
		...
		if (ambig && !exact) {
			if (opterr) {
				...
				System.err.println(MessageFormat.format(_messages
	...
	public int getopt() {
		...
		if ((long_options != null)
				&& (argv[optind].startsWith("--") || (long_only && ((argv[optind]
						.length() > 2) || (optstring.indexOf(argv[optind]
						.charAt(1)) == -1))))) {
